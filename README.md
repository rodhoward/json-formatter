JSON Swagger Formatter
==============

Chrome extension for displaying Swagger JSON docs in a quick and searchable way.

Features
--------
* Json formatting so fare not yet doing Swagger stuff.
